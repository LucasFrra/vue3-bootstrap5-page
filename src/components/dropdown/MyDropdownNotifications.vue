<!-- Create a Dropdown component for "Notifications" -->
...
<template>
  <div class="dropdown">
    ...
    <button type="button" class="button nav-link text-white-50" id="dropdownMenu" @mouseenter="handleShow($event)"
      ...
      <font-awesome-icon :icon="['fa', 'bell']" class="fa" /> Notifications
    </button>
    <ul class="dropdownMenu" aria-labelledby="dropdownMenu">
      <li class="ml-32px mt-3"><a class="dropdownItem" href="#" @click="handleHide($event)">Alerts</a></li>
      <li class="ml-32px mt-3"><a class="dropdownItem" href="#" @click="handleHide($event)">Badge</a></li>
      <li class="ml-32px mt-3"><a class="dropdownItem" href="#" @click="handleHide($event)">Modals</a></li>
      <li class="ml-32px mt-3"><a class="dropdownItem" href="#" @click="handleHide($event)">Toasts</a></li>
    </ul>
