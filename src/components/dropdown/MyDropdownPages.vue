<!-- Create a Dropdown component for "Pages" -->
...
<template>
  <div class="dropdown">
    ...
    <button type="button" class="button nav-link text-white-50" id="dropdownMenu" @mouseenter="handleShow($event)"
      ...
      <font-awesome-icon :icon="['fa', 'star']" class="fa" /> Pages
    </button>
    <ul class="dropdownMenu" aria-labelledby="dropdownMenu">
      <li class="mt-3"><a class="dropdownItem" href="#" @click="handleHide($event)">
          <font-awesome-icon :icon="['fa', 'right-to-bracket']" class="fa" />Login
        </a></li>
      <li class="mt-3"><a class="dropdownItem" href="#" @click="handleHide($event)">
          <font-awesome-icon :icon="['fa', 'right-to-bracket']" class="fa" />Register
        </a></li>
      <li class="mt-3"><a class="dropdownItem" href="#" @click="handleHide($event)">
          <font-awesome-icon :icon="['fa', 'bug']" class="fa" />Error 404
        </a></li>
      <li class="mt-3"><a class="dropdownItem" href="#" @click="handleHide($event)">
          <font-awesome-icon :icon="['fa', 'bug']" class="fa" />Error 500
        </a></li>
    </ul>
