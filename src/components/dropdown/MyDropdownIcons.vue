<!-- Create a Dropdown component for "Icons" -->
...
<template>
  <div class="dropdown">
    ...
    <button type="button" class="button nav-link text-white-50" id="dropdownMenu" @mouseenter="handleShow($event)"
      ...
      <font-awesome-icon :icon="['fa', 'star']" class="fa" /> Icons
    </button>
    <ul class="dropdownMenu" aria-labelledby="dropdownMenu">
      <li class="ml-32px mt-3"><a class="dropdownItem" href="#" @click="handleHide($event)">CoreUI Icons</a></li>
      <li class="ml-32px mt-3"><a class="dropdownItem" href="#" @click="handleHide($event)">CoreUI Icons - Brand</a>
      </li>
      <li class="ml-32px mt-3"><a class="dropdownItem" href="#" @click="handleHide($event)">CoreUI Icons - Flag</a></li>
    </ul>
